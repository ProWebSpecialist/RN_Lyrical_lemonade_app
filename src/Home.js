  ...
  _renderItem1 = ({item, index}) => {
    ...
    return (
        <View style={styles.itemContainer}>
          <ItemComponent carouselItemImage={imageUrl} itemTitle={videoTitle} itemSubTitle={author} carouselItemPlayImage={images.playIcon1} releasedAt={releasedAt} playlistId={playlistId} videoId={videoId} title={title} description={description} key={item.id}  navigation={this.props.navigation}></ItemComponent>
        </View>
    );
  }
