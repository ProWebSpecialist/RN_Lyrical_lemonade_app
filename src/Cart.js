  ...
  render(){
    ...
    return (
      <View style={styles.container}>
        ...
        {/* <Modal
          visible={this.state.isShipModal}
          swipeDirection={['up', 'down']} // can be string or an array
          swipeThreshold={200} // default 100
          onSwipeOut={(event) => {
            this.setState({ isShipModal: false });
          }}
          onTouchOutside={() => {
            this.setState({ isShipModal: false });
          }}
          footer={
            <ModalFooter style={{backgroundColor: 'grey', width: '100%'}}>
              <Image resizeMode="contain" source={require('../images/save.png')} style={styles.saveImage} />
              <ModalButton
                text="CANCEL"
                onPress={() => {}}
        ...
        >
          <ModalContent style={{backgroundColor: '#fafc00'}}>
                          <View style={{height: '5%'}}></View>
                          <InputComponent label="Street" place="143 Lemon Drop Ave" mTop="0%"></InputComponent>
                          <View style={{height: '5%'}}></View>
                          <InputComponent label="Country" place="United States" mTop="0%"></InputComponent>
          ...
          <ModalFooter style={{backgroundColor: '#f00'}}>
