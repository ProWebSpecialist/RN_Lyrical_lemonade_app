  ...
  _renderItem = ({item, index}) => {
    ...
    return (
        <View style={styles.itemContainer}>
            <ItemComponent carouselItemImage={imageUrl} itemTitle={title} itemSubTitle="" carouselItemPlayImage={images.sItemPlayImage} releasedAt={releasedAt} playlistId={playlistId} videoId={videoId} title={title} description={description} key={item.id}  navigation={this.props.navigation}></ItemComponent>
        </View>
    );
  }  
