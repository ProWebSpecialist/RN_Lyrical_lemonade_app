        ...
        return (
            <View style={styles.carouselItem}>
                ...
                <View style={styles.carouselItemPlay}>
                    {
                        blog ? <TouchableOpacity  onPress={() => {navigation.navigate('BlogShow', {link: link})}}><Image style={styles.carouselItemPlayImage} resizeMode="contain" source={carouselItemPlayImage} />
                        </TouchableOpacity> : <TouchableOpacity  onPress={() => {navigation.navigate('VideoPlay', {
                            videoId : videoId,
