        ...
        return (
            <View style={[styles.container, {flex: this.props.flexNum, marginTop: hp(this.props.mTop), marginLeft: this.props.mLeft}]}>
                ...
                <View style={styles.inputContainer}>
                    <TextInput style={[styles.input, {width: this.props.width}]} placeholder={this.props.place} placeholderTextColor="#000000" secureTextEntry={this.props.secure}  onChangeText={ text => {
